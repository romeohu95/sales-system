...
?>
<?php include($documentroot.'/partials/html.php'); ?>

<head>
	<?php
	$title = "Dashboard";
	include($documentroot.'/partials/title-meta.php'); ?>
	...
	<?php include($documentroot.'/partials/head-css.php'); ?>
</head>
...
<body>
    ...
    <div class="wrapper">
		...
		<?php include($documentroot.'/partials/menu.php'); ?>
        ...
        <div class="content-page">
			...
			<?php include($documentroot.'/partials/footer.php'); ?>
	...
	<?php include($documentroot.'/partials/right-sidebar.php'); ?>

	<?php include($documentroot.'/partials/footer-scripts.php'); ?>
